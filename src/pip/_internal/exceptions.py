...
class CollidingNameError(InstallationError):
    """Package seems to be typosquatted"""

    def __init__(self, packagename, suggestion):
    ...
    def __str__(self):
        # type: () -> str
        if not self.suggestion == None:
            return "Packagename " + self.packagename + " is a typosquat of " + self.suggestion
        else:
            return "Packagename " + self.packagename + " is a typosquat"
