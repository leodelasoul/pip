...
def pytest_collection_modifyitems(config, items):
    for item in items:
        ...
        if module_root_dir.startswith("experiment") or  module_root_dir.startswith("functional") or module_root_dir.startswith(
                "integration") or module_root_dir.startswith("lib"):
